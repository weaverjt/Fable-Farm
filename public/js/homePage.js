$(document).ready(function () {
    ...
    $.get("/api/top10stories", function (data) {

        console.log(data);
        for (var i in data) {

            $("#tenStories> tbody").append(`<tr class="fables"><td class="col-md-2" style="font-size: 70%">` + data[i].title + '</td><td class="col-md-2"  style="font-size: 70%">' +
